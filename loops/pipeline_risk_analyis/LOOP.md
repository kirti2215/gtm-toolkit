...
1. Direct customer-confirmed evidence (written commitment, signed doc)
2. Observed behavior (product usage, meeting attendance, response time)
3. Seller notes and call transcripts
4. CRM fields
5. Inferred patterns from similar deals
