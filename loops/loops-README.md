...
![Prompt vs. Skill vs. Loop](./assets/prompt-skill-loop-comparison.png)
...
![The Four-Loop Evidence System](./assets/four-loop-evidence-system.png)
...
![How the Loop Thinks](./assets/how-the-loop-thinks.png)
...
![Why a Target Was Not Enough](./assets/why-target-not-enough.png)
...
![Users Report Facts. The Loop Infers State.](./assets/users-report-facts-loop-infers-state.png)
...
![When Monitoring Becomes Adaptation](./assets/when-monitoring-becomes-adaptation.png)
...
![Three Kinds of Change](./assets/three-kinds-of-change.png)
...
![Plain Review vs. Annual GTM Loop](./assets/plain-review-vs-annual-gtm-loop.png)
...
![The Six Iterations That Changed the Architecture](./assets/six-iterations.png)
...
![How a GTM Team Uses the Loop](./assets/how-gtm-team-uses-loop.png)
...
│
└── assets/
    ├── prompt-skill-loop-comparison.png
    ├── four-loop-evidence-system.png
    ├── how-the-loop-thinks.png
    ├── why-target-not-enough.png
    ├── users-report-facts-loop-infers-state.png
    ├── when-monitoring-becomes-adaptation.png
    ├── three-kinds-of-change.png
    ├── plain-review-vs-annual-gtm-loop.png
    ├── how-gtm-team-uses-loop.png
    ├── six-iterations.png
    └── how-loops-were-evaluated.png
```
...
![How the Loops Were Evaluated](./assets/how-loops-were-evaluated.png)
